...
Welcome to the [INTX-Preevol](<[INTX-Preevol](https://github.com/DevPatelwork/INTX-Preevol)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/DevPatelwork/INTX-Preevol/issues).
- make sure it is not work in progress here [pull requests](https://github.com/DevPatelwork/INTX-Preevol/pulls).
- you can then [create an issue](https://github.com/DevPatelwork/INTX-Preevol/issues/new/choose) with the following information:
...
Thank you for contributing to [INTX-Preevol](https://github.com/DevPatelwork/INTX-Preevol) dont forget to give us a :star: !
