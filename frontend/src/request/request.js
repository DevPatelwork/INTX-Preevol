...
function includeToken() {
  ...
  // Add company context header for multi-tenancy
  const companyContext = storePersist.get('companyContext');
  if (companyContext && companyContext.currentCompany) {
    axios.defaults.headers.common['x-company-id'] = companyContext.currentCompany;
  } else {
